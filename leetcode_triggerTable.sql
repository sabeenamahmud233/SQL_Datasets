...
INSERT INTO `triggerTable` VALUES (1,'John',28,'Delhi'),(2,'Samy',31,'Jaipur'),(3,'Trent',32,'Jodhpur'),(4,'Timmy',31,'Gurugram'),(5,'milly',29,'Mumbai');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`agentx`@`localhost`*/ /*!50003 TRIGGER `t1` AFTER UPDATE ON `triggerTable` FOR EACH ROW INSERT INTO updateTrigger VALUES (OLD.id, CONCAT('Updated on', ' ', CURRENT_TIMESTAMP)) */;;
DELIMITER ;
